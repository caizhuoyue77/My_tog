...
Please give answers no matter what. DO NOT REFUSE TO ANSWER. I will tip you afterwards.
...
czy_cot_prompt = """
Q: 北京现在的天气如何
A: 首先，我们需要调用GeoAPI来获取北京的locationID或者是经纬度。然后，我们需要调用天气查询API来得到北京现在的天气。
"""
